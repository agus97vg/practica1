  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <form class="form-signin" action="EnvioMensajesAdminServlet" method="POST">
						...
						<div class="panel-body">
							...
							<div class="table-container">
								...
								<% 
									...
									int numero=(int) (miSesion.getAttribute("numeroMensajesAdmin"));
									ArrayList <Message> aloja =(ArrayList <Message>) miSesion.getAttribute("listaMensajesAdmin");
