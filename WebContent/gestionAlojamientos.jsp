			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Alojamientos</h3>
						<p>Estos son todos los alojamientos ofertados.</p>
					</div>
				</div>
				...
				<% 
					...
					ArrayList <Alojamiento> aloja =(ArrayList <Alojamiento>) miSesion.getAttribute("arrayAlojamientos");
					int numero=aloja.size();
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div>
							...
							<div class="desc">
								...
								<form method="POST" action="BotonModificarAlojamientoAdminServlet">
								...
								<form method="POST" action="EliminarAlojamientoAdminServlet">
										<a> <input type="hidden" name="miBotonAloja" value='<%=i%>' /> </a>
